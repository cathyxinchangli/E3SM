...
# Set paths
readonly CASE_ROOT="/global/homes/e/erick/Scripts/E3SM/cases/${CASE_NAME}"    #"${PSCRATCH}/E3SMv3/${CASE_NAME}"
readonly CODE_ROOT="${HOME}/Scripts/E3SM/code/${CHECKOUT}"
...
if [ "${run}" != "production" ]; then
  ...
  readonly WALLTIME="2:00:00" #"2:00:00"
